This project is just a playground to test how [jsPanel4](https://jspanel.de/) can be integrated with React JS without altering the jsPanel4 library.

[jsPanel4](https://jspanel.de/) is an amazing JS library written in vanilla javascript by [Stefan Sträßer](https://github.com/Flyer53/). It has no dependency.
